...
CJointBar::CJointBar( CString barName, SbVec3d trans)
{
	// 位移
	m_Trans = trans;
	// 初始化I型链接排
...
//////////////////////////////////////////////////////////////////////////
// 老式的布尔运算方法
SoGroup * CJointBar::CreateStraightBar()
{
	//////////////////////////////////////////////////////////////////////////
	// 老式的布尔运算方法
...
// 
void CJointBar::InitIStyleBar( void )
{
	m_Bar = new SoSeparator;
	//SoDepthBuffer *blueDepth =  new SoDepthBuffer;
	//blueDepth->test.setValue(TRUE);
...
COORDINATE3 CJointBar::CirclePt( float RadiusInput, float AngleInput )
{
...
vector<COORDINATE3> CJointBar::GetPoints( float RadiusInput )
{
	// 输入半径，以π的一半进行分割圆
...
void CJointBar::SetCircleDatad_A( void )
{
	//////////////////////////////////////////////////////////////////////////
	// 设置表面数据
	//////////////////////////////////////////////////////////////////////////
 ...
 wchar_t* CJointBar::Cstring2Wchar( CString cstr )
 {
 ...
 void CJointBar::setHwnd( Hwnd tt )
 {
	 mainHwnd = tt;
 }
