...
// LargeModelViewer.cpp : 定义应用程序的类行为。
//
...
// 唯一的一个 CLargeModelViewer 对象

CLargeModelViewerApp theApp;


// CLargeModelViewer 初始化
