 ...
 *==============================================================================
 *
 * Purpose : This program demonstrates how to use the SoReorganizeAction
 *           to replace shapes in the current scene graph by simplified versions
 *
 ******************************************************************************/
...
main(int argc, char **argv)
{
  ...
  if (argc == 2) {
    // if decimer object is NULL, just runs ivfix as usual
    printf("The scene graph will be simplified using a SoDecimator \n");
    SoDecimator *decimer = new SoDecimator;
    simplify = new SoReorganizeAction(decimer);
  } 
  else {
    printf("The scene graph will not be simplified. Just reorganized \n");
