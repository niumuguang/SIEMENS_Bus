...
// Use: virtual public
void
MyViewer::setCameraType(SoType myType)
//
////////////////////////////////////////////////////////////////////////
{
    if (myType.isDerivedFrom(SoPerspectiveCamera::getClassTypeId()) ||
	myType.isDerivedFrom(SoOrthographicCamera::getClassTypeId()))
	cameraType = myType;
#if defined(_DEBUG)
    else
...
//
void
MyViewer::setHeadlight(SbBool flag)
//
////////////////////////////////////////////////////////////////////////
{
...
// Use: virtual public
void
MyViewer::setDrawStyle(MyViewer::DrawType myType, MyViewer::DrawStyle style)
//
////////////////////////////////////////////////////////////////////////
{
...
// Use: public
MyViewer::DrawStyle
MyViewer::getDrawStyle(MyViewer::DrawType myType)
//
////////////////////////////////////////////////////////////////////////
{
    return (myType == STILL ? stillDrawStyle : interactiveDrawStyle);
}
...
// Use: virtual public
void
MyViewer::setBufferingType(MyViewer::BufferType myType)
//
////////////////////////////////////////////////////////////////////////
{
    if (bufferType == myType)
    	return;
...
////////////////////////////////////////////////////////////////////////
{
	...
	camera->orientation = 
	    SbRotation(SbVec3f(0, 1, 0), (float)(-stereoOffset * M_PI / 360.0)) * camOrigRot;
...
////////////////////////////////////////////////////////////////////////
{
    ...
    float cos_t = (float)(0.5 - 0.5 * cos(t * M_PI));
...
////////////////////////////////////////////////////////////////////////
{
    ...
    float farValue = - bbox.getMin()[2];
    float nearValue = - bbox.getMax()[2];
	...
	if (nearValue < (minimumNearPlane * farValue))
	    nearValue = minimumNearPlane * farValue;
    }
    ...
    if (camera->nearDistance.getValue() != nearValue)
	camera->nearDistance = nearValue;
    if (camera->farDistance.getValue() != farValue)
	camera->farDistance = farValue;
}
...
////////////////////////////////////////////////////////////////////////
{
	...
	float myHeight = camera->focalDistance.getValue() * (float)tan(angle/2);
	newCam = new SoOrthographicCamera;
	((SoOrthographicCamera *)newCam)->height = 2 * myHeight;
    }
    else if (camera->isOfType(SoOrthographicCamera::getClassTypeId())) {
	float myHeight = ((SoOrthographicCamera *)camera)->height.getValue() / 2;
	float angle = (float)atan(myHeight / camera->focalDistance.getValue());
...
////////////////////////////////////////////////////////////////////////
{
    ...
    float ang, dist;
    float vx = (float)(loc[0] - center[0]);
    float vy = (float)(loc[1] - center[1]);
    if (vx==0 && vy==0) {
	ang = 0;
	    dist = 3; // minimum size (given the circle thickness)
    }
    else {
	ang = (float)(atan2(vy, vx) * 180.0 / M_PI);
	dist = (float)sqrt(vx*vx + vy*vy);
	if (dist < 3)
	    dist = 3; // minimum size (given the circle thickness)
    }
