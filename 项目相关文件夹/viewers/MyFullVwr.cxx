...
#if !defined(sun) && !defined(_AIX) && !defined(__hpux) && !defined(__NUTC__) || defined(__osf__) || defined(__linux__)
...
// Use: virtual public
void
MyFullViewer::setDrawStyle(MyViewer::DrawType myType, 
				MyViewer::DrawStyle style)
//
////////////////////////////////////////////////////////////////////////
{
    // call base class routine
    MyViewer::setDrawStyle(myType, style);
...
// Use: virtual public
void
MyFullViewer::setBufferingType(MyViewer::BufferType myType)
//
////////////////////////////////////////////////////////////////////////
{
    // call base class routine
    MyViewer::setBufferingType(myType);
...
////////////////////////////////////////////////////////////////////////
{
    ...
    Arg args[8];
    int n = 0;
    SbVec2s mySize = getSize();
    if ((mySize[0] != 0) && (mySize[1] != 0)) {
	XtSetArg(args[n], XtNwidth, mySize[0]); n++;
	XtSetArg(args[n], XtNheight, mySize[1]); n++;
    }
    ...
    mgrWidget = XtCreateWidget(getWidgetName().getString(), xmFormWidgetClass, parent, args, n);
...
////////////////////////////////////////////////////////////////////////
{
	...
	XtAddCallback(w, XmNactivateCallback,
	    (XtCallbackProc) MyFullViewer::pushButtonCB, (XtPointer) (uintptr_t)i);
...
MyFullViewer::clipNearWheelCB(Widget, MyFullViewer *v, XtPointer *d)
{
	...
	dist *= (float)pow(80.0, (data->value - v->clipNearWheelVal) / 360.0);
...
MyFullViewer::clipFarWheelCB(Widget, MyFullViewer *v, XtPointer *d)
{
	...
	dist *= (float)pow(80.0, (data->value - v->clipFarWheelVal) / 360.0);
...
MyFullViewer::stereoWheelCB(Widget, MyFullViewer *v, XtPointer *d)
{
  ...
  if (data->reason == XmCR_DRAG) {
    ...
    v->setStereoOffset(v->getStereoOffset() * 
                       (float)pow(80.0, (data->value - v->stereoWheelVal) / 360.0));
...
MyFullViewer::seekDistWheelCB(Widget, MyFullViewer *v, XtPointer *d)
{
    ...
    v->seekDistance *= (float)pow(80.0, (data->value - v->seekDistWheelVal) / 360.0);
